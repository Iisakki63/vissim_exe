...
<sc version="202001" id="4" name="SigCont2" frequency="1" steps="0" defaultIntergreenMatrix="1" interstagesUsingMinDurations="true" checkSum="3688482655">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="SG2main" defaultSignalSequence="3">
      <defaultDurations>
    ...
    <sg id="3" name="SG2left" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
