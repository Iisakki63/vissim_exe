...
<sc version="202001" id="3" name="" frequency="1" steps="0" defaultIntergreenMatrix="1" interstagesUsingMinDurations="true" checkSum="85941158">
  <signaldisplays>
  ...
  <sgs>
    ...
    <sg id="2" name="SG2side" defaultSignalSequence="3">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="2" duration="1000" />
        <defaultDuration display="3" duration="5000" />
  ...
  <interstageProgs>
    <interstageProg id="1" cycletime="10000" intergreens="1" fromStage="1" toStage="2" name="1: Stage 1->2: Stage 2">
      <sgs>
    ...
    <interstageProg id="2" cycletime="10000" intergreens="1" fromStage="2" toStage="1" name="2: Stage 2->1: Stage 1">
      <sgs>
        <sg sg_id="1" signal_sequence="3">
          <cmds>
            <cmd display="1" begin="0" />
  ...
  <stageProgs>
    <stageProg id="1" cycletime="60000" switchpoint="0" offset="0" intergreens="1" fitness="0.000000" vehicleCount="0" name="Stage 1, Stage 2">
      <interstages>
        <interstage display="1" begin="20000" />
